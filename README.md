...
1. Create the flask [configuration file](https://flask.palletsprojects.com/en/3.0.x/config/#configuring-from-python-files). This is a `settings.py` module on the root of the `youbet` package.
